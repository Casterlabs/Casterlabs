...
export const CURRENCY_TABLE_INVERTED = {};
export const CURRENCIES = [];
export const PSUEDO_CURRENCIES = ["CAFFEINE_CREDITS", "CAFFEINE_GOLD", "TWITCH_BITS", "TWITCH BITS", "DEFAULT"];
...
Object.freeze(CURRENCY_TABLE);
Object.freeze(CURRENCY_TABLE_INVERTED);
Object.freeze(CURRENCIES);
Object.freeze(PSUEDO_CURRENCIES);
...
export async function convertAndFormatCurrency(amount, from, to) {
